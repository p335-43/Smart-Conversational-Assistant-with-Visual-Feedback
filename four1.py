...
class SpeechToSpeechBot:
    def __init__(self):
        ...
        # Language Model Setup (FLAN-T5)
        self.model = transformers.T5ForConditionalGeneration.from_pretrained('google/flan-t5-base')
        self.tokenizer = transformers.T5Tokenizer.from_pretrained('google/flan-t5-base')
